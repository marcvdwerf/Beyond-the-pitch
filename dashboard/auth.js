...
// 1. Directe beveiliging: Check of we op een dashboard zijn zonder sessie
...
document.addEventListener('DOMContentLoaded', () => {
    // Tab switching logica (alleen op index.html)
...
async function handleLogin(role) {
    ...
    try {
        ...
        if (result.status === "success") {
            // Opslaan in sessionStorage (stopt het knipperen)
